...
## [0.1.0](https://github.com/haythemsellami/revm/releases/tag/monad-revm-v0.1.0) - 2026-01-09

### Added

- precompiles multiplier for gas costs
...
- fmt
- clean MonadSpecId
- rename first monad spec to MonadEight
- update README
- account/storage cost tests
- implement From<SpecId> for MonadSpecId
- clean
- secp256r1 precompile
- override validate_env() in MonadHandler to revert in blob txs and skip block header validation
- Update monad-revm to use Monad bytecode size limit
- missing exports
- api
- MonadEvm wrapper
- different gas costs and future opcodes
- init MonadSpecId
- remove gas refund and pay up-to gas_limit
- init
- init
