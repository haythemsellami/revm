...
## [14.2.0](https://github.com/haythemsellami/revm/compare/revm-inspector-v14.1.0...revm-inspector-v14.2.0) - 2026-01-07
...
- replace HashMap with fixed-size array for opcode counts in CountInspector ([#3203](https://github.com/haythemsellami/revm/pull/3203))
