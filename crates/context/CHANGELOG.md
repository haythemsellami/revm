...
## [12.2.0](https://github.com/haythemsellami/revm/compare/revm-context-v12.1.0...revm-context-v12.2.0) - 2026-01-07
...
- set transaction_id on new account ([#3204](https://github.com/haythemsellami/revm/pull/3204))

### Other

- happy new year, 2026 licence ([#3272](https://github.com/haythemsellami/revm/pull/3272))
- add Display trait for ExecutionResult and related types ([#3267](https://github.com/haythemsellami/revm/pull/3267))
- add Display for HaltReason and OutOfGasError ([#3265](https://github.com/haythemsellami/revm/pull/3265))
- *(cleanup)* remove unused duplicate ContextSetters trait in context crate ([#3225](https://github.com/haythemsellami/revm/pull/3225))
